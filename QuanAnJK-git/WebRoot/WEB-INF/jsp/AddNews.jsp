    	...
    	<div class="centercontent" id="center">
    		...
    		<div id="contentwrapper" class="contentwrapper">
    			<div id="basicform" class="subcontent">           
					...
					<form class="stdform" action="addNews.action" method="post">
						<p>
                			<label>标题</label>
                			<span class="field">
                				<input id="txtTitle" type="text" name="title" class="longinput" placeholder="请输入新闻标题"/>
                			</span>
                		</p>
                		<p>
                			<label>来源</label>
                			<span class="field">
                				<input id="txtPublisher" type="text" name="publisher" class="longinput" placeholder="请输入新闻来源：作者或者出处"/>
                			</span>
                		</p>
                		<p>
                			<label>简介</label>
                			<span class="field">
                				<textarea id="txtProfile" name="profile" rows="2"  style="width: 80%">新闻简介索引</textarea><br/>
                			</span>
                		</p>
                		...
                		<p>
                			<label>内容</label>
                			<span class="field">
                				<textarea name="content" id="newsEditor" style="width: 80%">新闻编辑器</textarea><br/>
  								<script type="text/javascript">
